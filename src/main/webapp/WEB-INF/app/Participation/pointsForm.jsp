...
<form:form action="/app/tours/addPointsConfirmed" method="post" modelAttribute="pointAdd">
    ...
    <br/>
    <form:button class="myButton" type="submit">Dodaj</form:button> <input type="button" class="myButton" value="Powrót" onclick="location.href='/app/participation/addPointsList/${pointAdd.tourId}'">
</form:form>
